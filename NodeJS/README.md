...
-> is automaticaly connected to windwos system variable path
...
For this example we'll install the geostyler-sld-parser (https://github.com/terrestris/geostyler-sld-parser)
...
4. when you reopen the package.json file you'll see that there have been changes by the installation:
```
  "dependencies": {
...
npm install
```
You see, npm installs the geostyler-sld-parser package and its dependencies again without the need of defining it, because it's stated in the dependencies entry of package.json.
